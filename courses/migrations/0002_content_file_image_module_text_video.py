# Generated by Django 3.0.6 on 2020-10-01 09:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(choices=[('text', 'text'), ('video', 'video'), ('image', 'image'), ('file', 'file')], on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
